<template>
  <view>
    ...
    <view class="user_rank">
      <view class="rank">
        <text class="iconfont icon-icon-test7">{{ imgDetail.rank }}</text>
      </view>
      <view class="user_collect">
        <text class="iconfont icon-icon-test8">收藏</text>
      </view>
    </view>
      ...
      <view class="album_list">
        <view class="album_item" v-for="item in album" :key="item.id">
          ...
          <view class="album_info">
            ...
            <text class="iconfont icon-icon-test9"></text>
          </view>
        </view>
      </view>
    </view>
        ...
        <view class="comment_item" v-for="item in hot" :key="item.id">
          ...
          <view class="comment_user">
            ...
            <view class="user_name">
              ...
              <view class="user_tiem">{{item.cnTime}}</view>
            </view>
            <!-- 用户徽章 -->
          ...
          <view class="comment_desc">
            ...
            <view class="comment_like">
              <text class="iconfont icon-icon-test6">{{item.size}}</text>
            </view>
          </view>
        </view>
      </view>
...
export default {
  ...
  methods: {
    ...
    handleSwiperAction(e) {
      // console.log(e);
      const { imgList } = getApp().globalData;
      // 左滑：imgIndex++；右滑：imgIndex--；判断数组是否越界
    ...
    async handleDownload() {
      // 需要使用uni.downloadFile和uni.saveImageToPhotosAlbum这两个API
